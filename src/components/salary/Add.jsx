...
const Add = () => {
    const [salary,setSalary] = useState({
        enployeeId:null,basicSalary:0,allowances:0,deductions:0,paydate:null
    })
  ...
  return (
    ...
    <div className='max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                <label className='block text-sm font-medium text-gray-700'>Basic Salry</label>
                <input type='number' name="basicSalary" 
                onChange={handleChange} placeholder='Basic Salary' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required/>
            </div>
                        <div>
