...
const Add = () => {
    ...
    const handleSubmit= async(e)=>{
        ...
        try{
        const response = await axios.post("https://worktrack-backend.vercel.app/api/employee/add",formDataObj,{
            headers: {
    ...
    <div className='max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input type='date' name="dob" placeholder='DOB' onChange={handleChange} className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required/>
            </div>
            <div>
