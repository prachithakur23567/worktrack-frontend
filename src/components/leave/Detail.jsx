...
const Detail = () => {
    ...
    useEffect(()=>{
        const fetchLeave = async()=>{
            ...
            try{
                const response = await axios.get(`https://worktrack-backend.vercel.app/api/leave/detail/${id}`,{
                    headers:{
        ...
        const changeStatus = async(id,status)=>{
            ...
            try{
                const response = await axios.put(`https://worktrack-backend.vercel.app/api/leave/${id}`,{status},
                    {
                    headers:{
                        "Authorization":`Bearer ${localStorage.getItem('token')}`
                    }
  ...
  return (
    ...
    <div>
        <img src={`https://worktrack-backend.vercel.app/${leave.employeeId.userId.profileImage}`}
