...
export const getEmployees = async(id)=>{
    ...
    try{
        const response = await axios.get(`https://worktrack-backend.vercel.app/api/employee/department/${id}`,{
            headers:{
                "Authorization":`Bearer ${localStorage.getItem('token')}`
            }
        })
...
export const EmployeeButtons = ({Id}) => {
    ...
    return (
        <div className="flex space-x-3">
            ...
            <button className="px-3 py-1 bg-yellow-500 text-white" onClick={()=>navigate(`/admin-dashboard/employees/salary/${Id}`)}>Salary</button>
